...
def DenseNet(input):
    ...
    # bottleneck  = Dropout(rate=0.2)(bottleneck)
    ...
    out_layer1  = Dropout(rate=0.2)(out_layer1)
    ...
    out_layer2  = Dropout(rate=0.2)(out_layer2)
    ...
    out_layer3  = Dropout(rate=0.2)(out_layer3)
    ...
    out_layer5  = Dropout(rate=0.2)(out_layer5)
    ...
    out_layer6  = Dropout(rate=0.2)(out_layer6)
    ...
    out_layer7  = Dropout(rate=0.2)(out_layer7)
    ...
    out_layer9  = Dropout(rate=0.2)(out_layer9)
    ...
    out_layer10 = Dropout(rate=0.2)(out_layer10)
    ...
    out_layer11 = Dropout(rate=0.2)(out_layer11)
    ...
    out_layer12 = Dropout(rate=0.2)(out_layer12)
    ...
    out_layer13 = Dropout(rate=0.2)(out_layer13)
    ...
    out_layer14  = Dropout(rate=0.2)(out_layer14)
    ...
    out_layer15 = Dropout(rate=0.2)(out_layer15)
