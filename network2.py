...
def DenseNet(input):
    ...
    out_layer1  = Dropout(rate=0.2, name='DB1_Layer1_Drop')(out_layer1)

    # input_cat   = concatenate([x, out_layer1],axis=-1)
    input_cat   = out_layer1
    ...
    out_layer2  = Dropout(rate=0.2, name='DB1_Layer2_Drop')(out_layer2)

    input_cat   = concatenate([out_layer1, out_layer2],axis=-1)
    ...
    out_layer3  = Dropout(rate=0.2, name='DB1_Layer3_Drop')(out_layer3)

    input_cat   = concatenate([out_layer1, out_layer2, out_layer3],axis=-1)
    ...
    out_layer4  = Dropout(rate=0.2, name='DB1_Layer4_Drop')(out_layer4)

    # check for shape of feature map
    # Transition_1 (in:(120,72,120) -> out:(60,36,60))
    input_cat   = concatenate([out_layer1, out_layer2, out_layer3, out_layer4],axis=-1)
    ...
    out_layer1  = Dropout(rate=0.2, name='DB2_Layer1_Drop')(out_layer1)
    ...
    out_layer2  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', name='DB2_Layer2_Conv')(bottleneck)
    out_layer2  = BatchNormalization(name='DB2_Layer2_BN')(out_layer2)
    out_layer2  = Activation('relu', name='DB2_Layer2_Act')(out_layer2)
    out_layer2  = Dropout(rate=0.2, name='DB2_Layer2_Drop')(out_layer2)
    ...
    out_layer3  = Dropout(rate=0.2, name='DB2_Layer3_Drop')(out_layer3)
    ...
    out_layer4  = Dropout(rate=0.2, name='DB2_Layer4_Drop')(out_layer4)
    ...
    out_layer5  = Dropout(rate=0.2, name='DB2_Layer5_Drop')(out_layer5)

    input_cat   = concatenate([out_layer1, out_layer2, out_layer3, out_layer4, out_layer5],axis=-1)
    ...
    out_layer6  = Dropout(rate=0.2, name='DB2_Layer6_Drop')(out_layer6)

    input_cat   = concatenate([out_layer1, out_layer2, out_layer3, out_layer4, out_layer5, out_layer6],axis=-1)
    ...
    out_layer7  = Dropout(rate=0.2, name='DB2_Layer7_Drop')(out_layer7)

    input_cat   = concatenate([out_layer1, out_layer2, out_layer3, out_layer4, out_layer5, out_layer6, out_layer7],axis=-1)
    ...
    out_layer8  = Dropout(rate=0.2, name='DB2_Layer8_Drop')(out_layer8)

    # Transition_2 (in:(60,36,60) -> out:(30,18,30))
    input_cat   = concatenate([out_layer1, out_layer2, out_layer3, out_layer4, out_layer5, out_layer6, out_layer7, out_layer8],axis=-1)
    ...
    out_layer1  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer1_Conv')(bottleneck)
    out_layer1  = BatchNormalization(name='DB3_Layer1_BN')(out_layer1)
    out_layer1  = Activation('relu', name='DB3_Layer1_Act')(out_layer1)
    out_layer1  = Dropout(rate=0.2, name='DB3_Layer1_Drop')(out_layer1)
    ...
    out_layer2  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer2_Conv')(bottleneck)
    out_layer2  = BatchNormalization(name='DB3_Layer2_BN')(out_layer2)
    out_layer2  = Activation('relu', name='DB3_Layer2_Act')(out_layer2)
    out_layer2  = Dropout(rate=0.2, name='DB3_Layer2_Drop')(out_layer2)
    ...
    out_layer3  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer3_Conv')(bottleneck)
    out_layer3  = BatchNormalization(name='DB3_Layer3_BN')(out_layer3)
    out_layer3  = Activation('relu', name='DB3_Layer3_Act')(out_layer3)
    out_layer3  = Dropout(rate=0.2, name='DB3_Layer3_Drop')(out_layer3)
    ...
    out_layer4  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer4_Conv')(bottleneck)
    out_layer4  = BatchNormalization(name='DB3_Layer4_BN')(out_layer4)
    out_layer4  = Activation('relu', name='DB3_Layer4_Act')(out_layer4)
    out_layer4  = Dropout(rate=0.2, name='DB3_Layer4_Drop')(out_layer4)
    ...
    out_layer5  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer5_Conv')(bottleneck)
    out_layer5  = BatchNormalization(name='DB3_Layer5_BN')(out_layer5)
    out_layer5  = Activation('relu', name='DB3_Layer5_Act')(out_layer5)
    out_layer5  = Dropout(rate=0.2, name='DB3_Layer5_Drop')(out_layer5)
    ...
    out_layer6  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer6_Conv')(bottleneck)
    out_layer6  = BatchNormalization(name='DB3_Layer6_BN')(out_layer6)
    out_layer6  = Activation('relu', name='DB3_Layer6_Act')(out_layer6)
    out_layer6  = Dropout(rate=0.2, name='DB3_Layer6_Drop')(out_layer6)
    ...
    out_layer7  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer7_Conv')(bottleneck)
    out_layer7  = BatchNormalization(name='DB3_Layer7_BN')(out_layer7)
    out_layer7  = Activation('relu', name='DB3_Layer7_Act')(out_layer7)
    out_layer7  = Dropout(rate=0.2, name='DB3_Layer7_Drop')(out_layer7)
    ...
    out_layer8  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer8_Conv')(bottleneck)
    out_layer8  = BatchNormalization(name='DB3_Layer8_BN')(out_layer8)
    out_layer8  = Activation('relu', name='DB3_Layer8_Act')(out_layer8)
    out_layer8  = Dropout(rate=0.2, name='DB3_Layer8_Drop')(out_layer8)

    input_cat   = concatenate([out_layer1, out_layer2, out_layer3, out_layer4, out_layer5, out_layer6, out_layer7,
                                out_layer8],axis=-1)
    ...
    out_layer9  = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer9_Conv')(bottleneck)
    out_layer9  = BatchNormalization(name='DB3_Layer9_BN')(out_layer9)
    out_layer9  = Activation('relu', name='DB3_Layer9_Act')(out_layer9)
    out_layer9  = Dropout(rate=0.2, name='DB3_Layer9_Drop')(out_layer9)
    ...
    out_layer10 = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer10_Conv')(bottleneck)
    ...
    out_layer10 = Dropout(rate=0.2, name='DB3_Layer10_Drop')(out_layer10)
    ...
    out_layer11 = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer11_Conv')(bottleneck)
    ...
    out_layer11 = Dropout(rate=0.2, name='DB3_Layer11_Drop')(out_layer11)
    ...
    out_layer12 = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer12_Conv')(bottleneck)
    ...
    out_layer12 = Dropout(rate=0.2, name='DB3_Layer12_Drop')(out_layer12)
    ...
    out_layer13 = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer13_Conv')(bottleneck)
    ...
    out_layer13 = Dropout(rate=0.2, name='DB3_Layer13_Drop')(out_layer13)
    ...
    out_layer14 = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer14_Conv')(bottleneck)
    ...
    out_layer14  = Dropout(rate=0.2, name='DB3_Layer14_Drop')(out_layer14)
    ...
    out_layer15 = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer15_Conv')(bottleneck)
    ...
    out_layer15 = Dropout(rate=0.2, name='DB3_Layer15_Drop')(out_layer15)
    ...
    out_layer16 = Conv3D(growth_rate, kernel_size=3, strides=1, padding='same', dilation_rate=2, name='DB3_Layer16_Conv')(bottleneck)
    ...
    out_layer16 = Dropout(rate=0.2, name='DB3_Layer16_Drop')(out_layer16)
    ...
    input_cat   = concatenate([out_layer1, out_layer2, out_layer3, out_layer4, out_layer5, out_layer6, out_layer7,out_layer8,
                                out_layer9, out_layer10, out_layer11, out_layer12, out_layer13, out_layer14, out_layer15, out_layer16],axis=-1)
