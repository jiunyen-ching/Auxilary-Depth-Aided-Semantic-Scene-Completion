...
def get_dense_unet_u(y):
    ...
    # Dilated Dense_Block1_1
    down4_1 = BatchNormalization()(x)
    down4_1 = Activation('relu')(down4_1)
    down4_1 = Conv3D(4 * growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(down4_1)
    down4_1 = BatchNormalization()(down4_1)
    down4_1 = Activation('relu')(down4_1)
    down4_1 = Conv3D(growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(down4_1)
    concat = concatenate([x,down4_1], axis=-1)

    # Dilated Dense_Block1_2
    down4_2 = BatchNormalization()(concat)
    down4_2 = Activation('relu')(down4_2)
    down4_2 = Conv3D(4 * growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(down4_2)
    down4_2 = BatchNormalization()(down4_2)
    down4_2 = Activation('relu')(down4_2)
    down4_2 = Conv3D(growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(down4_2)
    concat = concatenate([x,down4_1,down4_2], axis=-1)

    down4_t = BatchNormalization()(concat)
    down4_t = Activation('relu')(down4_2)
    down4_t = Conv3D(64, (3, 3, 3), padding='same', dilation_rate=2)(down4_2)
    down4_pool = MaxPooling3D((2, 2, 2), strides=(2, 2, 2))(down4_t)
    # Out: 15 x 9 x 15

    # Skip-conn for Dilated Resnet_Block2_1
    x = Conv3D(128, (3, 3, 3), padding='same')(down4_pool)

    # Dilated Dense_Block2_1
    center_1 = BatchNormalization()(x)
    center_1 = Activation('relu')(center_1)
    center_1 = Conv3D(4 * growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(center_1)
    center_1 = BatchNormalization()(center_1)
    center_1 = Activation('relu')(center_1)
    center_1 = Conv3D(growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(center_1)
    concat = concatenate([x,center_1], axis=-1)

    # Dilated Dense_Block2_2
    center_2 = BatchNormalization()(concat)
    center_2 = Activation('relu')(center_2)
    center_2 = Conv3D(4 * growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(center_2)
    center_2 = BatchNormalization()(center_2)
    center_2 = Activation('relu')(center_2)
    center_2 = Conv3D(growth_rate, (3, 3, 3), padding='same', dilation_rate=2)(center_2)
    concat = concatenate([x,center_1,center_2], axis=-1)

    center_t = BatchNormalization()(concat)
    center_t = Activation('relu')(center_t)
    center_t = Conv3D(128, (3, 3, 3), padding='same', dilation_rate=2)(center_t)
    # center

    up4 = Conv3DTranspose(64, (2, 2, 2), strides=(2,2,2))(center_t)
    res = concatenate([down4_t, up4], axis=-1)
